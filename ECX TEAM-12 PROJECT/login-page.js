...
const enteredpassword=document.forms[0][2];
const submitBtn=document.forms[0][4];
const rememberMeBtn=document.forms[0][8];
const forgotPassword=document.forms[0][9];
let click=0;
